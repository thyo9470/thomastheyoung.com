...
if($_SESSION["is_host"]){
    $suggest = Jockey::with_all( $_SESSION["access"], $_SESSION["refresh"], TRUE);
}else{
    $suggest = Jockey::with_all( $_SESSION["access"], $_SESSION["refresh"], FALSE, $_SESSION["session"]);
}
    ...
    <div class="fluid-container">
      <div id="mainContainer" class="container">
        <div id="info" class="text-center">
            ...
            <?php
                if($_SESSION["is_host"]){
                    echo "<p>{$_SESSION['session'][1]}</p>";
                }else{
                    echo "<p>{$_SESSION['session'][1]}</p>";
                }
            ?>
            <a class="nav-item nav-link" href="https://open.spotify.com" target="_blank">Open Spotify</a>
        </div>
      </div>
    </div>
