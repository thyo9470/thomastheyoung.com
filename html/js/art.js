...
function setImage(size, path, name){
  var modalOut = "<div class='carousel-item active'><img class='d-block w-100 modal-content display-picture' src=" + path + String(1) + name +"></div>"
  var indicator = "<li class='active' data-target='#carousel' data-slide-to='0'>1</li>";
  $('#image-container').append(modalOut);
  $('.carousel-indicators').append(indicator);
  for(i = 2; i <= size; i++){
    modalOut = "<div class='carousel-item'><img class='d-block w-100 modal-content display-picture' role='listbox' src=" + path + String(i) + name +"></div>"
